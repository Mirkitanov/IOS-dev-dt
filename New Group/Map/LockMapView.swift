...
/**
 View для отображения в случае, если LocationService недоступен.

 Предоставляет встроенное описание и возможность отображать кнопку с настраиваемым действием
 */
